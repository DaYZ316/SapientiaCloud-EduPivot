...
public class MinIOController {
    ...
    public Result<FileInfoDTO> getFileInfo(
        ...
        try {
            FileInfoDTO fileInfo = minIOUtil.getFileInfo(objectName, resolveBucketCode(bucketCode));
            return Result.success(fileInfo);
        } catch (Exception e) {
    ...
    public Result<FileInfoDTO> getFileInfoByPath(
        ...
        try {
            FileInfoDTO fileInfo = minIOUtil.getFileInfoByPath(filePath, resolveBucketCode(bucketCode));
            return Result.success(fileInfo);
        } catch (Exception e) {
            throw new BusinessException(MinIOConstants.FILE_INFO_FAILED_MESSAGE + ": " + e.getMessage());
        }
    ...
    public Result<List<FileInfoDTO>> getBatchFileInfo(
        ...
        try {
            List<FileInfoDTO> fileInfoList = minIOUtil.getBatchFileInfo(objectNames, resolveBucketCode(bucketCode));
    ...
    public Result<List<FileInfoDTO>> getBatchFileInfoByPath(
        ...
        try {
            List<FileInfoDTO> fileInfoList = minIOUtil.getBatchFileInfoByPath(filePaths, resolveBucketCode(bucketCode));
            return Result.success(fileInfoList);
        } catch (Exception e) {
            throw new BusinessException(MinIOConstants.FILE_INFO_FAILED_MESSAGE + ": " + e.getMessage());
        }
