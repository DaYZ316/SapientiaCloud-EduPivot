package com.dayz.sapientiacloud_edupivot.live.common.aspect;
...
public class FeignRequestAspect {
     ...
     * 定义切点，匹配内部接口
     */
    @Pointcut("@annotation(com.dayz.sapientiacloud_edupivot.live.common.security.annotation.HasPermission)")
