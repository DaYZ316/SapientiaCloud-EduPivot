...
public class CacheConfig {
    ...
    public static final String PUBLIC_COURSE_CACHE = "PublicCourse";
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        RedisCacheConfiguration publicCourseConfig = RedisCacheConfiguration.defaultCacheConfig()
                .entryTtl(PUBLIC_COURSE_CACHE_TTL)
                .serializeKeysWith(RedisSerializationContext.SerializationPair.fromSerializer(new StringRedisSerializer()))
                .serializeValuesWith(RedisSerializationContext.SerializationPair.fromSerializer(jsonSerializer))
                .disableCachingNullValues();

        Map<String, RedisCacheConfiguration> cacheConfigurations = new HashMap<>();
        cacheConfigurations.put(PUBLIC_COURSE_CACHE, publicCourseConfig);
