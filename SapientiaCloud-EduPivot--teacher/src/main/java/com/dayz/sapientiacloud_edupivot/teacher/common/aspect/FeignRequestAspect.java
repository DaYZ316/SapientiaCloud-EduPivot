package com.dayz.sapientiacloud_edupivot.teacher.common.aspect;
...
public class FeignRequestAspect {
     ...
     * 定义切点，匹配内部接口
     */
    @Pointcut("@annotation(com.dayz.sapientiacloud_edupivot.teacher.common.security.annotation.HasPermission)")
