...
public class QuestionConstants {
    ...
    public static final String QUESTION_SYSTEM_PROMPT = """
            ...
            23. 同一套题中如果出现向量、矩阵、单位矩阵，必须统一粗体风格；默认优先使用 \\boldsymbol{...}，若选择 \\mathbf{...} 则整套题保持一致，不要混用。
            24. 公式内部若存在逗号、条件并列或并列关系，为提升可读性可适度加入 \\, 或 \\quad 等间距命令；例如 $\\alpha_i \\ge 0, \\, \\sum_i \\alpha_i = 1$ 这类表达应保证视觉间距自然。
            """;
