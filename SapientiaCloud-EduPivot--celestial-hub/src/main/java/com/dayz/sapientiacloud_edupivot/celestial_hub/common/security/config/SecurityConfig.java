package com.dayz.sapientiacloud_edupivot.celestial_hub.common.security.config;

import com.dayz.sapientiacloud_edupivot.celestial_hub.common.security.filter.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        // ASYNC dispatch不需要重新授权，因为初始REQUEST已经通过了授权检查
