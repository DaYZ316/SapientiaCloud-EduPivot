...
public interface CourseClient {
	...
	Result<List<QuestionOptionVO>> listOptionsByQuestionId(@PathVariable("questionId") UUID questionId);

	@GetMapping("/internal/question-answer/{id}")
	Result<QuestionAnswerVO> getQuestionAnswerById(@PathVariable("id") UUID id);

	@GetMapping("/internal/question-answer/question/{questionId}")
	Result<List<QuestionAnswerVO>> listQuestionAnswersByQuestionId(@PathVariable("questionId") UUID questionId);
}
