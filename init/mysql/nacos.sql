...
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_bin COMMENT = '多租户改造' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of his_config_info
-- ----------------------------
INSERT INTO `his_config_info` VALUES (6, 12, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\r\n  helper-dialect: mysql\r\n  reasonable: true\r\n  support-methods-arguments: true\r\n  params: count=countSql\r\n\r\nmybatis-plus:\r\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\r\n  mapper-locations: classpath:mapper/**/*.xml\r\n  configuration:\r\n    cache-enabled: false\r\n    map-underscore-to-camel-case: true\r\n  global-config:\r\n    db-config:\r\n      id-type: assign_id\r\n      update-strategy: not_null\r\n      logic-delete-field: deleted\r\n      logic-delete-value: 1\r\n      logic-not-delete-value: 0\r\n\r\nfeign:\r\n  client:\r\n    config:\r\n      default:\r\n        connectTimeout: 5000\r\n        readTimeout: 5000\r\n        loggerLevel: full\r\n  httpclient:\r\n    enabled: true\r\n\r\nspring:\r\n  jpa:\r\n    open-in-view: false\r\n    show-sql: true\r\n    hibernate:\r\n      ddl-auto: update', '0300dfa307f15cd7d15857fc26fc470e', '2025-09-22 14:36:44', '2025-09-22 22:36:44', 'nacos', '172.18.0.1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 13, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\n  helper-dialect: mysql\n  reasonable: true\n  support-methods-arguments: true\n  params: count=countSql\n\nmybatis-plus:\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\n  mapper-locations: classpath:mapper/**/*.xml\n  configuration:\n    cache-enabled: false\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      id-type: assign_id\n      update-strategy: not_null\n      logic-delete-field: deleted\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: full\n  httpclient:\n    enabled: true\n\nspring:\n  jpa:\n    open-in-view: false\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n  data:\n    mongodb:\n      host: ${MONGODB_HOST}\n      port: ${MONGODB_PORT}\n      database: ${MONGODB_DATABASE}\n      username: ${MONGODB_USERNAME}\n      password: ${MONGODB_PASSWORD}\n      authentication-database: ${MONGODB_AUTH_DATABASE}\n      \n      \nMONGODB_HOST: localhost\nMONGODB_PORT: 27017\nMONGODB_DATABASE: sapientiacloud_edupivot\nMONGODB_USERNAME: root\nMONGODB_PASSWORD: zhaosheng123\nMONGODB_AUTH_DATABASE: admin', 'cdcfccec82060a9a03999123e249576f', '2025-09-23 11:34:22', '2025-09-23 19:34:22', 'nacos', '172.18.0.1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 14, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\n  helper-dialect: mysql\n  reasonable: true\n  support-methods-arguments: true\n  params: count=countSql\n\nmybatis-plus:\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\n  mapper-locations: classpath:mapper/**/*.xml\n  configuration:\n    cache-enabled: false\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      id-type: assign_id\n      update-strategy: not_null\n      logic-delete-field: deleted\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: full\n  httpclient:\n    enabled: true\n\nspring:\n  jpa:\n    open-in-view: false\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n  data:\n    mongodb:\n      uri: mongodb://root:zhaosheng123@localhost:27017/sapientiacloud_edupivot?authSource=admin\n      \n      \nMONGODB_HOST: localhost\nMONGODB_PORT: 27017\nMONGODB_DATABASE: sapientiacloud_edupivot\nMONGODB_USERNAME: root\nMONGODB_PASSWORD: zhaosheng123\nMONGODB_AUTH_DATABASE: admin', 'e74bf7274279617d8fd3069f4aa48e87', '2025-09-23 11:35:39', '2025-09-23 19:35:40', NULL, '172.18.0.1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 15, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\n  helper-dialect: mysql\n  reasonable: true\n  support-methods-arguments: true\n  params: count=countSql\n\nmybatis-plus:\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\n  mapper-locations: classpath:mapper/**/*.xml\n  configuration:\n    cache-enabled: false\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      id-type: assign_id\n      update-strategy: not_null\n      logic-delete-field: deleted\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: full\n  httpclient:\n    enabled: true\n\nspring:\n  jpa:\n    open-in-view: false\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n  data:\n    mongodb:\n      host: ${MONGODB_HOST}\n      port: ${MONGODB_PORT}\n      database: ${MONGODB_DATABASE}\n      username: ${MONGODB_USERNAME}\n      password: ${MONGODB_PASSWORD}\n      authentication-database: ${MONGODB_AUTH_DATABASE}\n      \n      \nMONGODB_HOST: localhost\nMONGODB_PORT: 27017\nMONGODB_DATABASE: sapientiacloud_edupivot\nMONGODB_USERNAME: root\nMONGODB_PASSWORD: zhaosheng123\nMONGODB_AUTH_DATABASE: admin', 'cdcfccec82060a9a03999123e249576f', '2025-09-23 11:36:06', '2025-09-23 19:36:06', 'nacos', '172.18.0.1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 16, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\n  helper-dialect: mysql\n  reasonable: true\n  support-methods-arguments: true\n  params: count=countSql\n\nmybatis-plus:\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\n  mapper-locations: classpath:mapper/**/*.xml\n  configuration:\n    cache-enabled: false\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      id-type: assign_id\n      update-strategy: not_null\n      logic-delete-field: deleted\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: full\n  httpclient:\n    enabled: true\n\nspring:\n  jpa:\n    open-in-view: false\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n  data:\n    mongodb:\n      host: ${MONGODB_HOST}\n      port: ${MONGODB_PORT}\n      database: ${MONGODB_DATABASE}\n      username: ${MONGODB_USERNAME}\n      password: ${MONGODB_PASSWORD}\n      authentication-database: ${MONGODB_AUTH_DATABASE}\n      \n      \nMONGODB_HOST: localhost\nMONGODB_PORT: 27017\nMONGODB_DATABASE: sapientiacloud_edupivot\nMONGODB_USERNAME: root\nMONGODB_PASSWORD: zhaosheng12\nMONGODB_AUTH_DATABASE: admin', '2402ae5cbd5b6f5288aaaa23cf08cb46', '2025-09-23 11:36:39', '2025-09-23 19:36:40', 'nacos', '172.18.0.1', 'U', '', '');
INSERT INTO `his_config_info` VALUES (6, 17, 'SapientiaCloud-EduPivot--course.yaml', 'DEFAULT_GROUP', '', 'pagehelper:\n  helper-dialect: mysql\n  reasonable: true\n  support-methods-arguments: true\n  params: count=countSql\n\nmybatis-plus:\n  type-aliases-package: com.dayz.sapientiacloud_edupivot.course.entity\n  mapper-locations: classpath:mapper/**/*.xml\n  configuration:\n    cache-enabled: false\n    map-underscore-to-camel-case: true\n  global-config:\n    db-config:\n      id-type: assign_id\n      update-strategy: not_null\n      logic-delete-field: deleted\n      logic-delete-value: 1\n      logic-not-delete-value: 0\n\nfeign:\n  client:\n    config:\n      default:\n        connectTimeout: 5000\n        readTimeout: 5000\n        loggerLevel: full\n  httpclient:\n    enabled: true\n\nspring:\n  jpa:\n    open-in-view: false\n    show-sql: true\n    hibernate:\n      ddl-auto: update\n  data:\n    mongodb:\n      host: ${MONGODB_HOST}\n      port: ${MONGODB_PORT}\n      database: ${MONGODB_DATABASE}\n      username: ${MONGODB_USERNAME}\n      password: ${MONGODB_PASSWORD}\n      authentication-database: ${MONGODB_AUTH_DATABASE}\n      \n      \nMONGODB_HOST: localhost\nMONGODB_PORT: 27017\nMONGODB_DATABASE: sapientiacloud_edupivot\nMONGODB_USERNAME: root\nMONGODB_PASSWORD: zhaosheng123\nMONGODB_AUTH_DATABASE: admin', 'cdcfccec82060a9a03999123e249576f', '2025-09-27 03:54:34', '2025-09-27 11:54:34', 'nacos', '172.18.0.1', 'U', '', '');
