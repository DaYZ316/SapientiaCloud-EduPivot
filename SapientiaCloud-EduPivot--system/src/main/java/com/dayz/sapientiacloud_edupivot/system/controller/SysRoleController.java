...
public class SysRoleController {
    ...
    @Operation(summary = "分页查找角色", description = "根据传入的条件分页查询角色信息。支持根据角色名、角色描述等字段进行模糊查询。")
    @GetMapping("/list")
    ...
    @Operation(summary = "更新现有角色", description = "修改现有角色的信息。")
    @PutMapping
    ...
    @Operation(summary = "删除角色", description = "根据角色ID从系统中移除角色。")
    @DeleteMapping("/{id}")
