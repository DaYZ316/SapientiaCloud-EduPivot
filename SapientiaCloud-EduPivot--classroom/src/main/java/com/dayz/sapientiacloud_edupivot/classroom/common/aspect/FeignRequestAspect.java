package com.dayz.sapientiacloud_edupivot.classroom.common.aspect;
...
public class FeignRequestAspect {
     ...
     * 定义切点，匹配内部接口
     */
    @Pointcut("@annotation(com.dayz.sapientiacloud_edupivot.classroom.common.security.annotation.HasPermission)")
