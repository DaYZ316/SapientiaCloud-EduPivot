package com.dayz.sapientiacloud_edupivot.classroom.common.security.utils;

import com.dayz.sapientiacloud_edupivot.classroom.common.clients.SysUserClient;
        ...
        return Optional.ofNullable(SecurityContextHolder.getContext().getAuthentication())
                ...
                .map(principal -> {
                    try {
                        ...
                        throw new BusinessException("用户ID格式不正确: " + e.getMessage());
                    }
                })
