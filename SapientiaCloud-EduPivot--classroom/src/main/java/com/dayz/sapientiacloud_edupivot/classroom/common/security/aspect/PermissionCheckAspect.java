package com.dayz.sapientiacloud_edupivot.classroom.common.security.aspect;

import com.dayz.sapientiacloud_edupivot.classroom.common.clients.SysPermissionClient;
import com.dayz.sapientiacloud_edupivot.classroom.common.enums.ResultEnum;
...
public class PermissionCheckAspect {
     ...
     */
    @Before("@annotation(com.dayz.sapientiacloud_edupivot.classroom.common.security.annotation.HasPermission)")
    public void checkPermission(JoinPoint joinPoint) {
        ...
        // 获取用户所有权限
        List<String> permissionKeys = sysPermissionClient.getUserPermissions(userId).getData();
